...
class DocumentImpl extends NodeImpl {
  ...
  _xmlElementBuilder(document, tagName) {
  ...
  _createElementWithCorrectElementInterface(name, namespace) {
    ...
    const builder = namespace === 'https://www.w3.org/1999/xml'?
        this._xmlElementBuilder.bind(this) :
        (this._elementBuilders[name.toLowerCase()] || this._defaultElementBuilder.bind(this));
